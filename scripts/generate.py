#!/usr/bin/env python3
"""Generate eza's Apollo theme.yml from the bundled palette snapshot."""
...
def main() -> int:
    ...
    parser.add_argument("--check", action="store_true", help="fail if theme.yml is stale")
